self.addEventListener('message', function(e) {
  ...
  if (packer === 'evalencode') {
    ...
    try {
      self.importScripts('https://aprendiendoconxsplus.github.io/demoapp/proyecto-pro/d30bfusc4t0r/aadecode.js');
    ...
    try {
      self.importScripts('https://aprendiendoconxsplus.github.io/demoapp/proyecto-pro/d30bfusc4t0r/jjdecode.js');
    ...
    try {
      self.importScripts('https://aprendiendoconxsplus.github.io/demoapp/proyecto-pro/d30bfusc4t0r/urlencode_unpacker.js');
    ...
    try {
      self.importScripts('https://aprendiendoconxsplus.github.io/demoapp/proyecto-pro/d30bfusc4t0r/p_a_c_k_e_r_unpacker.js');
    ...
    try {
      self.importScripts('https://aprendiendoconxsplus.github.io/demoapp/proyecto-pro/d30bfusc4t0r/javascriptobfuscator_unpacker.js');
    ...
    try {
      self.importScripts('https://aprendiendoconxsplus.github.io/demoapp/proyecto-pro/d30bfusc4t0r/myobfuscate_unpacker.js');
