(function() {
  ...
  var input = document.getElementById('input'),
    ...
    format = debounce(function() {
      ...
      if (source === '') return;
      if (!workerFormat) {
        workerFormat = createWorker('https://aprendiendoconxsplus.github.io/demoapp/proyecto-pro/d30bfusc4t0r/format.js');
    ...
    decode = debounce(function() {
      ...
      if (!workerDecode) {
        workerDecode = createWorker('https://aprendiendoconxsplus.github.io/demoapp/proyecto-pro/d30bfusc4t0r/decode.js');
